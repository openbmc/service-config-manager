...
void ServiceConfig::loadStateFile()
{
    if (std::filesystem::exists(stateFile))
    {
        ...
        {
            lg2::info("Masked property for {FILEPATH} not equal", "FILEPATH",
                      stateFile);
        ...
        {
            lg2::info("Enabled property for {FILEPATH} not equal", "FILEPATH",
                      stateFile);
        ...
        {
            lg2::info("Running property for {FILEPATH} not equal", "FILEPATH",
                      stateFile);
